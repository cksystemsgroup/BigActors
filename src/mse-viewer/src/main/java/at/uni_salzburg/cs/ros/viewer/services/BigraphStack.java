 ...
 * BigraphStack
 */
public class BigraphStack implements JavaScriptStack
{
     ...
     */
    public BigraphStack(final AssetSource assetSource)
    {
        stylesheets =
            new StylesheetLink[]
            {
                TapestryInternalUtils.assetToStylesheetLink.map(assetSource
                    .getUnlocalizedAsset("/at/uni_salzburg/cs/ros/viewer/css/bigraph.css")),
            };
        javaScriptLibraries =
            new Asset[]
            {
                assetSource.getUnlocalizedAsset("/at/uni_salzburg/cs/ros/viewer/js/bigraph.js"),
            };
    }
