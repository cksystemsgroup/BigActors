 ...
 */
@EagerLoad
public class BrrListenerImpl extends AbstractNodeMain implements BrrListener
{
    private static final Logger LOG = LoggerFactory.getLogger(BrrListenerImpl.class);
    
    private std_msgs.String message;

    private BigraphReactionRuleArchive archive;
    
    public BrrListenerImpl(BigraphReactionRuleArchive archive)
    {
    ...
    {
        return GraphName.of("brr_listener");
    }
    ...
    public void onStart(ConnectedNode connectedNode)
    {
        ...
        Subscriber<std_msgs.String> subscriber =
            connectedNode.newSubscriber("brr", std_msgs.String._TYPE);
        ...
        subscriber.addMessageListener(new MessageListener<std_msgs.String>()
        {
            ...
            {
                message = newMessage;
                LOG.info("onNewMessage() BRR received");
                try
                {
                ...
                {
                    LOG.error("Can not archive BRR.", e);
                }
            }
        });
    }
