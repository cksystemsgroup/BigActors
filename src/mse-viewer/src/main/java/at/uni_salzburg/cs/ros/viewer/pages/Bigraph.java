...
public class Bigraph
{
    ...
    public void importStack()
    {
        ...
        js.addScript("bup = new BigraphUpdater('bigraph');" +
    ...
    public StreamResponse onActivate(String command, String imageId)
    {
        ...
        return new PngImageStreamResponse(null);
    }

    /**
     * PngImageStreamResponse
     */
    private static class PngImageStreamResponse implements StreamResponse
    {
    ...
    private static class JSONStreamResponse implements StreamResponse
    {
